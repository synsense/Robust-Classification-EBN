...
for idx,ax in enumerate(top_row_axes):
    ...
    ax.set_yticks([])
    ax.set_ylim([-0.5,1.0])
    ax.text(x=t_start+0.01, y=1.2, s=labels[idx], fontsize=16, fontweight="bold")
    ax.text(
        (t_start + t_stop)/2, 1.2,
        s = titles[idx],
...
l1 = ax3.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+rate_net_dynamics[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw)
l2 = ax3.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+dynamics_original[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw, linestyle="--")
...
ax3.set_xticks([])
ax3.set_yticks([])
ax3.set_ylim([-1.3,plot_num*0.5+0.7])
ax3.legend(lines, [r"Target dynamics $\hat{\mathbf{x}}$", r"Recon. dynamics $\tilde{\mathbf{x}}$"], loc='lower left', frameon=False, prop={'size': 5})
leg = ax3.get_legend()
leg.legendHandles[0].set_color('black')
leg.legendHandles[1].set_color('black')

ax4 = fig.add_subplot(gs[2:6,2:4])
l1 = ax4.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+rate_net_dynamics[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw)
l2 = ax4.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+dynamics_mm[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw, linestyle="--")
for line, color in zip(l1,colors):
    line.set_color(color)
for line, color in zip(l2,colors):
    line.set_color(color)
...
ax4.set_ylim([-1.3,plot_num*0.5+0.7])
ax4.axis('off')


ax13 = fig.add_subplot(gs[2:6,4:6])
l1 = ax13.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+rate_net_dynamics[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw)
l2 = ax13.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+dynamics_disc[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw, linestyle="--")
for line, color in zip(l1,colors):
    line.set_color(color)
for line, color in zip(l2,colors):
    line.set_color(color)
...
ax13.set_ylim([-1.3,plot_num*0.5+0.7])
ax13.axis('off')

ax15 = fig.add_subplot(gs[2:6,6:8])
l1 = ax15.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+rate_net_dynamics[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw)
l2 = ax15.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+dynamics_ina[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw, linestyle="--")
for line, color in zip(l1,colors):
    line.set_color(color)
for line, color in zip(l2,colors):
    line.set_color(color)
...
ax15.set_ylim([-1.3,plot_num*0.5+0.7])
ax15.axis('off')

ax5 = fig.add_subplot(gs[2:6,10:12])
l1 = ax5.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+rate_net_dynamics[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw)
l2 = ax5.plot(time_base[(time_base > t_start) & (time_base < t_stop)], 0.5+dynamics_failure[(time_base > t_start) & (time_base < t_stop),:plot_num], linewidth=dynamics_lw, linestyle="--")
for line, color in zip(l1,colors):
    line.set_color(color)
for line, color in zip(l2,colors):
    line.set_color(color)
...
ax5.axis('off')
ax5.set_ylim([-1.3,plot_num*0.5+0.7])
ax5.plot([t_start_suppress,t_start_suppress],[-0.0, plot_num*0.5+0.5], color="r", linewidth=1)
ax5.plot([t_stop_suppress,t_stop_suppress],[-0.0, plot_num*0.5+0.5], color="r", linewidth=1)
...
ax8.plot([t_start_suppress,t_start_suppress],[-20,800], color="r", linewidth=1)
ax8.plot([t_stop_suppress,t_stop_suppress],[-20,800], color="r", linewidth=1)
...
ax9.plot(time_base, rate_output[int(t_start/0.001):int(t_start/0.001)+len(time_base)], color="C2", label=r"$\hat{\mathbf{y}}_{\textnormal{rate}}$")
ax9.plot(time_base, final_out[int(t_start/0.001):int(t_start/0.001)+len(time_base)], color="C4", linestyle="--", label=r"$\tilde{\mathbf{y}}_{\textnormal{spiking}}$")
ax9.plot(time_base, tgt_signal[int(t_start/0.001):int(t_start/0.001)+len(time_base)], color="black", linestyle="dotted", label=r"$\mathbf{y}_{\textnormal{target}}$")
ax9.legend(frameon=False, loc=[0, .7], prop={'size': 5})
...
ax9.set_xticks([])
ax9.set_yticks([])
ax9.plot([t_start,t_start+0.2], [-0.3,-0.3], color="k", linewidth=2)
ax9.text(x=t_start+0.01, y=-0.9, s="200 ms")
...
ax10.plot(time_base, tgt_signal[int(t_start/0.001):int(t_start/0.001)+len(time_base)], color="black", linestyle="dotted")
...
ax15.plot(time_base, tgt_signal[int(t_start/0.001):int(t_start/0.001)+len(time_base)], color="black", linestyle="dotted")
...
ax17.plot(time_base, tgt_signal[int(t_start/0.001):int(t_start/0.001)+len(time_base)], color="black", linestyle="dotted")
...
ax11.plot(tmp_times[(tmp_times > t_start) & (tmp_times < t_stop)], tgt_signal[(tmp_times > t_start) & (tmp_times < t_stop)], color="black", linestyle="dotted")
ax11.set_ylim([-0.4,1.4])
ax11.plot([t_start_suppress,t_start_suppress],[-0.1, 1.5], color="r", linewidth=1)
ax11.plot([t_stop_suppress,t_stop_suppress],[-0.1, 1.5], color="r", linewidth=1)
ax11.axes.get_yaxis().set_visible(False)
ax11.axes.get_xaxis().set_visible(False)
ax11.axis('off')
ax11.plot([t_start,t_start+0.4], [-0.3,-0.3], color="k", linewidth=2)
ax11.text(x=t_start+0.01, y=-0.9, s="400 ms")
...
lines = [l1[0],l2[0]]
ax12.legend(lines, [r"MSE Perturbed", r"MSE Original"], loc=[0, 1], frameon=False, prop={'size': 5})
leg = ax12.get_legend()
ax12.plot([t_start_suppress,t_start_suppress],[-1, 10.0], color="r", linewidth=1)
ax12.plot([t_stop_suppress,t_stop_suppress],[-1, 10.0], color="r", linewidth=1)

...
if __name__ == "__main__":
    ...
    ads_orig_final_path = f'/home/julian/Documents/RobustClassificationWithEBNs/membranePotentialNoise/Resources/Plotting/ads{network_idx}_jax{postfix}_noise_analysis_output.json'

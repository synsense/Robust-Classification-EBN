# - Execute this script using $ python figure2.py --num 768 --tau-slow 0.07 --tau-out 0.07 --epochs 5 --threshold 0.7 --eta 0.0001 --num-val 500 --num-test 1000 --verbose 1 --percentage-data 0.1
...
class HeySnipsNetworkADS(BaseModel):
    def __init__(self,
        ...
        # - Create NetworkADS
        file_name_path = f"Resources/ads{self.network_idx}.json"
        self.model_path_ads_net = os.path.join(self.base_path, file_name_path)

        np.random.seed(seed)

        if(os.path.exists(self.model_path_ads_net)):
            print("This model instance was already trained")
            sys.exit(0)
        else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--network-idx', default="", type=str, help="Number of network instances to train")
    parser.add_argument('--seed', default=42, type=int, help="Seed used for reproducability")

...
python BPTT/hey_snips_bptt.py --num ${NUM_NEURONS_BPTT} --epochs 20 --threshold 0.7 --verbose 1 --percentage-data 0.1
echo "Evaluating mismatch robustness of BPTT network..."
python BPTT/hey_snips_bptt_mismatch.py --verbose 0 --percentage-data 0.1 --num-trials 50
echo "Training reservoir network..."
python Reservoir/hey_snips_reservoir.py --percentage-data 0.1
...
python FORCE/hey_snips_force.py --num 768 --verbose 0 --tau-syn 0.02 --tau-mem 0.01 --alpha 0.00001 --epochs 15 --percentage-data 0.1
